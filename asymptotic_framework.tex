...
\todo[inline]{This shouldn't be a separate assumption. Just include it in the preceding one.}
\begin{assump}
\label{assump:add}
...
\todo[inline]{Clean this assumption up and add references to it in the right places}
...
\item[(h)] $\sqrt{n}f_n(\beta_0) \rightarrow_d \mathscr{N} + \left[
  \begin{array}{c}
    0 \\ \tau
  \end{array}
\right]$
