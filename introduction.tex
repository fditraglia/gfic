...
Section \ref{sec:REvsFE} specializes the GFIC to the problem of choosing between random effects and fixed effects estimators, and proposes an estimator that optimally averages the two while Section \ref{sec:panel} considers a dynamic panel example.
Section \ref{sec:simulation} presents the results of simulation studies for each of the two examples and Section \ref{sec:conclude} concludes. 
